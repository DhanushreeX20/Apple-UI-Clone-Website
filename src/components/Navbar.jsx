function Navbar() {
  return (
    <nav className="fixed top-0 left-0 w-full h-[48px] bg-[#161617]/80 backdrop-blur-xl text-white/70 px-4 flex items-center z-50">
      ...
      <div className="flex w-full items-center justify-between lg:justify-center">
        ...
        {/* RIGHT ICONS */}
        <div className="flex items-center space-x-6 ml-4 lg:ml-10">

          {/* Search */}
          <svg height="50" viewBox="0 0 17 48" width="17" fill="currentcolor">
